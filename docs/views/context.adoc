...
Estas fronteras solo acotan lo que debe estar listo y operando en la primera entrega.
...
image::Contexto/Diagrama-contexto-general.png[Diagrama de contexto general, width=800, align=center]
