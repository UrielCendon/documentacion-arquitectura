...
| Descripción | El huésped con cuenta inicia una reservación indicando hotel, fechas y tipo de habitación. El sistema valida disponibilidad y procede al pago para confirmar la reservación.
| Actor(es) | Huésped
| Disparador | El huésped elige reservar una habitación.
| Precondiciones | -PRE-01: Existen hoteles activos en el sistema. +
-PRE-02: Existen tipos de habitación activos en el sistema. +
-PRE-03: El huésped tiene una cuenta en el sistema.
| Flujo normal |
1.- El sistema reconoce la sesión del huésped y solicita el hotel, las fechas de estancia y el tipo de habitación a reservar. (Ver FA 1.1) +
2.- El huésped ingresa hotel, fechas y tipo de habitación. +
3.- El sistema valida las entradas y consulta su inventario. Si hay cupo, solicita el método de pago e incluye al CU-04 Realizar el pago de la reservación. Al regresar con un pago aprobado, el sistema confirma la reservación, asigna un folio único, comunica la política de cancelación y registra la operación. (Ver FA 3.1) (Ver FA 3.2) (Ver FA 3.3) (Ver EX 1) (Ver EX 2) (Ver EX 3) (Ver EX 4) +
4.- Termina el caso de uso.
| Flujos alternos |
FA 1.1 El huésped no tiene una sesión iniciada. +
1.- El sistema extiende al CU-29 Crear Cuenta. +
2.- Si el huésped crea una cuenta, retorna al paso 1 del flujo normal. +
3.- Si el huésped no crea una cuenta, termina el caso de uso. +
