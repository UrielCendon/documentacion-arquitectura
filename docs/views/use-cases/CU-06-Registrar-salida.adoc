...
| Descripción | El recepcionista realiza el registro de salida de una estancia activa. El sistema consolida cargos, procesa pagos, libera la habitación y registra la operación en la bitácora de auditoría.
| Actor(es) | Recepcionista
| Disparador | El recepcionista selecciona realizar el registro de salida.
| Precondiciones | -PRE-01: El recepcionista está autenticado en el sistema. +
-PRE-02: Existe una estancia activa (El registro de entrada fue realizado).
| Flujo normal |
...
FA 3.2 Registro de salida exprés (saldo cero). +
