...
| Flujo normal |
1.- El sistema muestra los hoteles del gerente y solicita los datos del recepcionista. + (nombre, apellido, email, telefono, contraseña). +
2.- El gerente elige el hotel y captura los datos solicitados. +
