...
| Descripción | El recepcionista registra la entrada de un huésped a partir de una reserva o estancia programada. El sistema valida elegibilidad, garantías y disponibilidad, actualiza el estado de la habitación y deja trazabilidad en la bitácora de auditoría.
| Actor(es) | Recepcionista
| Disparador | El recepcionista selecciona realizar el registro de entrada.
...
4.- El recepcionista confirma el registro de entrada e indica el medio de garantía/cobro. +
5.- El sistema registra la entrada, cambia la habitación a "ocupada", genera credenciales/llaves y registra la operación en auditoría. (Ver EX 2) +
...
3.- El sistema aplica la elección (reasigna o agenda registro de entrada diferido), registra en auditoría y regresa al paso 3 del flujo normal o finaliza si se difiere. +
FA 3.2 Registro de entrada anticipado con cargo. +
