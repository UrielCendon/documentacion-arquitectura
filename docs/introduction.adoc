= Sistema de Gestión de una Cadena Hotelera
...
*Curso:* {course}
*Periodo:* {period}
*Fecha de Entrega:* {revdate}
*Repositorio del Proyecto:* link:https://github.com/UrielCendon/documentacion-arquitectura[documentacion-arquitectura]
